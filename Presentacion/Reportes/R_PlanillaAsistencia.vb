...
Public Class R_PlanillaAsistencia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_PlanillaAsistencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_PlanillaAsistencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_PlanillaAsistencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_PlanillaAsistencia = New R_PlanillaAsistencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
