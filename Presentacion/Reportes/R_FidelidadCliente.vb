...
Public Class R_FidelidadCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FidelidadCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FidelidadCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FidelidadCliente = New R_FidelidadCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
