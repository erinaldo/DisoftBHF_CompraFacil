...
Public Class R_Clientes_R
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Clientes_R.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Clientes_R
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Clientes_R = New R_Clientes_R()
        rpt.Site = Me.Site
        Return rpt
    End Function
