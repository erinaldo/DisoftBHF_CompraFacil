...
Public Class R_VisitasDiarias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VisitasDiarias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VisitasDiarias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VisitasDiarias = New R_VisitasDiarias()
        rpt.Site = Me.Site
        Return rpt
    End Function
