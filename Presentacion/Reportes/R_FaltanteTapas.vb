...
Public Class R_FaltanteTapas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FaltanteTapas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FaltanteTapas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FaltanteTapas = New R_FaltanteTapas()
        rpt.Site = Me.Site
        Return rpt
    End Function
