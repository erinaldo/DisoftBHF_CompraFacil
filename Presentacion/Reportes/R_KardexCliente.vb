...
Public Class R_KardexCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_KardexCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_KardexCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_KardexCliente = New R_KardexCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
