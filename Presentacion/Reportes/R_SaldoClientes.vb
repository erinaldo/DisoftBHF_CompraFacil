...
Public Class R_SaldoClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SaldoClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SaldoClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SaldoClientes = New R_SaldoClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
