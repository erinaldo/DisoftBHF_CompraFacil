...
Public Class R_ResumenNotas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ResumenNotas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ResumenNotas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ResumenNotas = New R_ResumenNotas()
        rpt.Site = Me.Site
        Return rpt
    End Function
