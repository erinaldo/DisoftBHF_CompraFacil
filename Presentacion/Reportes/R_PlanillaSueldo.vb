...
Public Class R_PlanillaSueldo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_PlanillaSueldo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_PlanillaSueldo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_PlanillaSueldo = New R_PlanillaSueldo()
        rpt.Site = Me.Site
        Return rpt
    End Function
