...
Public Class R_UltimosPedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_UltimosPedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_UltimosPedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_UltimosPedidos = New R_UltimosPedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
