...
Public Class R_Transacciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Transacciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Transacciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Transacciones = New R_Transacciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
