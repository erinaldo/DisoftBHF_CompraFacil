...
Public Class R_EntregaPedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_EntregaPedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EntregaPedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EntregaPedidos = New R_EntregaPedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
