...
Public Class R_StockDisponible
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_StockDisponible.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockDisponible
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockDisponible = New R_StockDisponible()
        rpt.Site = Me.Site
        Return rpt
    End Function
