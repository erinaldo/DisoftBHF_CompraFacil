...
Public Class R_ReciboCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReciboCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReciboCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReciboCliente = New R_ReciboCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
