...
Public Class R_PrestamoEquiposDetallado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_PrestamoEquiposDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_PrestamoEquiposDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_PrestamoEquiposDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_PrestamoEquiposDetallado = New R_PrestamoEquiposDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
