...
Public Class R_SaldoInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SaldoInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SaldoInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SaldoInventario = New R_SaldoInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
