...
Public Class R_GraficaVentasVs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_GraficaVentasVs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_GraficaVentasVs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_GraficaVentasVs = New R_GraficaVentasVs()
        rpt.Site = Me.Site
        Return rpt
    End Function
