...
Public Class R01_EstadoCuentasCliente
...
#Region "METODOS PRIVADOS"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosClientes.Checked) Then
            _dt = L_prListarClienteEstadoCuentasTodos(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
            Return
        End If
        If (checkUnCliente.Checked) Then
            _dt = L_prListarClienteEstadoCuentasPorCliente(tbCodigoVendedor.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
            Return
        End If
    ...
    Public Sub _prListarDistribuidores()
        ...
        If (bandera = True) Then
            ...
            If (IsNothing(Row)) Then
                ...
                Return
            End If
            tbCodigoVendedor.Text = Row.Cells("ccnumi").Value
